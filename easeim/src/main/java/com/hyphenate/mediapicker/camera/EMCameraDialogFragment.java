 ...
 */
public class EMCameraDialogFragment extends DialogFragment {
    ...
    public void setConfig(Fragment fragment, EMMediaPickerConfig config) {
        this.fragment = new WeakReference<>(fragment);
        this.config = config;
        this.fragmentActivity = null;
    }

    public void setConfig(FragmentActivity fragmentActivity, EMMediaPickerConfig config) {
        this.fragment = null;
        this.config = config;
