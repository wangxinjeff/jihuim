...
public class EMSelectedPreviewActivityEM extends EMBasePreviewActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        List<EMItem> selected = bundle.getParcelableArrayList(EMSelectedItemCollection.STATE_SELECTION);
