 ...
 * description:媒体扫描
 */
public class EMSingleMediaScanner implements MediaScannerConnection.MediaScannerConnectionClient {
    ...
    public EMSingleMediaScanner(Context context, String mPath, ScanListener mListener) {
        this.mPath = mPath;
