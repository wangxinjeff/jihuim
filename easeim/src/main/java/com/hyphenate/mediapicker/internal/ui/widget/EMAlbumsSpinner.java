...
public class EMAlbumsSpinner {
    ...
    public EMAlbumsSpinner(@NonNull Context context) {
        mListPopupWindow = new ListPopupWindow(context, null, R.attr.emlistPopupWindowStyle);
        ...
        mListPopupWindow.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                EMAlbumsSpinner.this.onItemSelected(parent.getContext(), position);
...
//        }
    ...
    public void setSelectedTextView(TextView textView) {
        ...
        TypedArray ta = mSelected.getContext().getTheme().obtainStyledAttributes(
                new int[]{R.attr.emalbum_element_color});
