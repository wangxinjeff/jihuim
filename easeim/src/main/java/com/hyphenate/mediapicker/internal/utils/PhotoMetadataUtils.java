...
public final class PhotoMetadataUtils {
    private static final String TAG = com.hyphenate.mediapicker.internal.utils.PhotoMetadataUtils.class.getSimpleName();
    ...
    public static Point getBitmapSize(Uri uri, Activity activity) {
        ...
        int w = imageSize.x;
        int h = imageSize.y;
        if (com.hyphenate.mediapicker.internal.utils.PhotoMetadataUtils.shouldRotate(resolver, uri)) {
            w = imageSize.y;
            h = imageSize.x;
        }
    ...
    private static boolean shouldRotate(ContentResolver resolver, Uri uri) {
        ExifInterface exif;
        try {
            exif = com.hyphenate.mediapicker.internal.utils.ExifInterfaceCompat.newInstance(getPath(resolver, uri));
        } catch (IOException e) {
