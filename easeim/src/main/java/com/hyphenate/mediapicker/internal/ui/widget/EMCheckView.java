...
public class EMCheckView extends View {
    ...
    public EMCheckView(Context context) {
        super(context);
        init(context);
    }

    public EMCheckView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public EMCheckView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        TypedArray ta = getContext().getTheme().obtainStyledAttributes(new int[]{R.attr.emitem_checkCircle_borderColor});
        int defaultColor = ResourcesCompat.getColor(
                getResources(), R.color.em_zhihu_item_checkCircle_borderColor,
                getContext().getTheme());
    ...
    private void initBackgroundPaint() {
        if (mBackgroundPaint == null) {
            ...
            TypedArray ta = getContext().getTheme()
                    .obtainStyledAttributes(new int[]{R.attr.emitem_checkCircle_backgroundColor});
            int defaultColor = ResourcesCompat.getColor(
                    getResources(), R.color.em_zhihu_item_checkCircle_backgroundColor,
                    getContext().getTheme());
            int color = ta.getColor(0, defaultColor);
            ta.recycle();
