...
public class EMAlbumMediaAdapter extends
    ...
    public EMAlbumMediaAdapter(Context context, EMSelectedItemCollection selectedCollection, RecyclerView recyclerView) {
        super(null);
