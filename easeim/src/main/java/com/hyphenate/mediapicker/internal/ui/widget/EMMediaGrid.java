 ...
 */
package com.hyphenate.mediapicker.internal.ui.widget;
...
public class EMMediaGrid extends EMSquareFrameLayout implements View.OnClickListener {

    private ImageView mThumbnail;
    private EMCheckView mCheckView;
    private ImageView mGifTag;
    private TextView mVideoDuration;

    private EMItem mMedia;
    private PreBindInfo mPreBindInfo;
    private OnMediaGridClickListener mListener;

    public EMMediaGrid(Context context) {
        super(context);
        init(context);
    }

    public EMMediaGrid(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void bindMedia(EMItem item) {
        mMedia = item;
        setGifTag();
        initCheckView();
        setImage();
    ...
    private void setImage() {
        if (mMedia.isGif()) {
            EMSelectionSpec.getInstance().EMImageEngine.loadGifThumbnail(getContext(), mPreBindInfo.mResize,
                    mPreBindInfo.mPlaceholder, mThumbnail, mMedia.getContentUri());
        } else {
            EMSelectionSpec.getInstance().EMImageEngine.loadThumbnail(getContext(), mPreBindInfo.mResize,
                    mPreBindInfo.mPlaceholder, mThumbnail, mMedia.getContentUri());
        }
    }
    ...
    public interface OnMediaGridClickListener {
        ...
        void onThumbnailClicked(ImageView thumbnail, EMItem item, RecyclerView.ViewHolder holder);

        void onCheckViewClicked(EMCheckView checkView, EMItem item, RecyclerView.ViewHolder holder);
    }
