...
public class EMPreviewItemFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if (item.isGif()) {
            EMSelectionSpec.getInstance().EMImageEngine.loadGifImage(getContext(), size.x, size.y, image,
                    item.getContentUri());
        } else {
            EMSelectionSpec.getInstance().EMImageEngine.loadImage(getContext(), size.x, size.y, image,
                    item.getContentUri());
        }
    }
