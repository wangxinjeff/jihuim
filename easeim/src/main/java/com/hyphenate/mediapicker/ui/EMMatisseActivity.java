...
import com.hyphenate.mediapicker.internal.ui.EMAlbumPreviewActivity;
...
import com.hyphenate.mediapicker.internal.ui.EMSelectedPreviewActivity;
...
public class EMMatisseActivity extends BaseInitActivity implements
        ...
        EMAlbumMediaAdapter.CheckStateListener, EMAlbumMediaAdapter.OnMediaClickListener,
        EMAlbumMediaAdapter.OnPhotoCapture {
    ...
    private final EMAlbumCollection mAlbumCollection = new EMAlbumCollection();
    private EMMediaStoreCompat mMediaStoreCompat;
    ...
    private EMAlbumsAdapter mAlbumsAdapter;
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        if (mSpec.capture) {
            mMediaStoreCompat = new EMMediaStoreCompat(this);
        ...
        mAlbumsAdapter = new EMAlbumsAdapter(this, null, false);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_preview) {
            Intent intent = new Intent(this, EMSelectedPreviewActivity.class);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        EMAlbum album = EMAlbum.valueOf(mAlbumsAdapter.getCursor());
    ...
    public void onMediaClick(EMAlbum album, EMItem item, int adapterPosition) {
        Intent intent = new Intent(this, EMAlbumPreviewActivity.class);
        intent.putExtra(EMAlbumPreviewActivity.EXTRA_ALBUM, album);
        intent.putExtra(EMAlbumPreviewActivity.EXTRA_ITEM, item);
        intent.putExtra(EMBasePreviewActivity.EXTRA_DEFAULT_BUNDLE, mSelectedCollection.getDataWithBundle());
        intent.putExtra(EMBasePreviewActivity.EXTRA_RESULT_ORIGINAL_ENABLE, mOriginalEnable);
        startActivityForResult(intent, REQUEST_CODE_PREVIEW);
    }
