...
public enum EMMimeType {
    ...
    EMMimeType(String mimeTypeName, Set<String> extensions) {
        mMimeTypeName = mimeTypeName;
        mExtensions = extensions;
    }

    public static Set<EMMimeType> ofAll() {
        return EnumSet.allOf(EMMimeType.class);
    }

    public static Set<EMMimeType> of(EMMimeType type, EMMimeType... rest) {
        return EnumSet.of(type, rest);
    }

    public static Set<EMMimeType> ofImage() {
        return EnumSet.of(JPEG, PNG, GIF, BMP, WEBP);
    }

    public static Set<EMMimeType> ofImage(boolean onlyGif) {
        return EnumSet.of(GIF);
    }

    public static Set<EMMimeType> ofGif() {
        return ofImage(true);
    }

    public static Set<EMMimeType> ofVideo() {
    ...
    public static boolean isGif(String mimeType) {
        if (mimeType == null) return false;
        return mimeType.equals(EMMimeType.GIF.toString());
    }
    ...
    public boolean checkType(ContentResolver resolver, Uri uri) {
        ...
        for (String extension : mExtensions) {
            ...
            if (!pathParsed) {
                ...
                path = EMPhotoMetadataUtils.getPath(resolver, uri);
