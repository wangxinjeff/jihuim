...
public class EMCaptureLayout extends FrameLayout {
    ...
    private EMReturnListener returnListener;      //退出按钮监听
    private EMClickListener leftClickListener;    //左边按钮监听
    private EMClickListener rightClickListener;   //右边按钮监听
    ...
    public void setReturnLisenter(EMReturnListener returnListener) {
...
//                resetCaptureLayout();
    ...
    public void setLeftClickListener(EMClickListener leftClickListener) {
        this.leftClickListener = leftClickListener;
    }

    public void setRightClickListener(EMClickListener rightClickListener) {
