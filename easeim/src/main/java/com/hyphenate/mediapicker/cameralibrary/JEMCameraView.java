...
//    private static final String TAG = "JCameraView";
    ...
    //回调监听
    private JEMCameraListener jCameraListener;
    private EMClickListener leftClickListener;
    private EMClickListener rightClickListener;
    ...
    private EMCaptureLayout mCaptureLayout;
    private EMFocusView mFocusView;
...
//            }
//        });
        mCaptureLayout = (EMCaptureLayout) view.findViewById(R.id.capture_layout);
        mCaptureLayout.setDuration(duration);
        mCaptureLayout.setIconSrc(iconLeft, iconRight);
        mFocusView = (EMFocusView) view.findViewById(R.id.fouce_view);
        ...
        //拍照 录像
        mCaptureLayout.setCaptureLisenter(new EMCaptureListener() {
            @Override
        ...
        //确认 取消
        mCaptureLayout.setTypeLisenter(new EMTypeListener() {
            @Override
            public void cancel() {
...
//            }
//        });
        mCaptureLayout.setLeftClickListener(new EMClickListener() {
            @Override
            public void onClick() {
        ...
        mCaptureLayout.setRightClickListener(new EMClickListener() {
            @Override
            public void onClick() {
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setJCameraListener(JEMCameraListener jCameraListener) {
        this.jCameraListener = jCameraListener;
    }


    private EMErrorListener errorListener;

    //启动Camera错误回调
    public void setErrorListener(EMErrorListener errorListener) {
        this.errorListener = errorListener;
        EMCameraInterface.getInstance().setErrorLinsenter(errorListener);
    }
...
//                    mMediaPlayer.setDataSource(url);
    ...
    public void setLeftClickListener(EMClickListener clickListener) {
        this.leftClickListener = clickListener;
    }

    public void setRightClickListener(EMClickListener clickListener) {
