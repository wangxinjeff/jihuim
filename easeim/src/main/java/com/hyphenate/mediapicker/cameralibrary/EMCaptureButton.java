...
import static com.hyphenate.mediapicker.cameralibrary.JEMCameraView.BUTTON_STATE_BOTH;
import static com.hyphenate.mediapicker.cameralibrary.JEMCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.hyphenate.mediapicker.cameralibrary.JEMCameraView.BUTTON_STATE_ONLY_RECORDER;
 ...
 * =====================================
 */
public class EMCaptureButton extends View {
    ...
    private EMCaptureListener captureLisenter;        //按钮回调接口
    private RecordCountDownTimer timer;             //计时器

    public EMCaptureButton(Context context) {
        super(context);
    }

    public EMCaptureButton(Context context, int size) {
        super(context);
        ...
        EMLogUtil.i("CaptureButtom start");
        duration = 10 * 1000;              //默认最长录制时间为10s
        EMLogUtil.i("CaptureButtom end");
    ...
    private class LongPressRunnable implements Runnable {
        ...
        public void run() {
            ...
            //没有录制权限
            if (EMCheckPermission.getRecordState() != EMCheckPermission.STATE_SUCCESS) {
                state = STATE_IDLE;
                if (captureLisenter != null) {
