 ...
 * =====================================
 */
public class EMCameraParamUtil {
    private static final String TAG = "JCameraView";
    private CameraSizeComparator sizeComparator = new CameraSizeComparator();
    private static EMCameraParamUtil EMCameraParamUtil = null;

    private EMCameraParamUtil() {

    }

    public static EMCameraParamUtil getInstance() {
        if (EMCameraParamUtil == null) {
            EMCameraParamUtil = new EMCameraParamUtil();
            return EMCameraParamUtil;
        } else {
            return EMCameraParamUtil;
        }
    }
