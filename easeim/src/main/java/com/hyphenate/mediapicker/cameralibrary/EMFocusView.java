 ...
 * =====================================
 */
public class EMFocusView extends View {
    private int size;
    ...
    public EMFocusView(Context context) {
        this(context, null);
    }

    public EMFocusView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EMFocusView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.size = EMScreenUtils.getScreenWidth(context) / 3;
        mPaint = new Paint();
