...
public class EMMediaPathUtil {
    ...
    private static EMMediaPathUtil instance = null;
    ...
    private EMMediaPathUtil() {

    }

    public static EMMediaPathUtil getInstance() {
        if (instance == null) {
            instance = new EMMediaPathUtil();
        }
