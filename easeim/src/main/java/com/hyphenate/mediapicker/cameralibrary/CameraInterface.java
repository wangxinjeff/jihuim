...
import com.hyphenate.mediapicker.cameralibrary.util.AngleUtil;
import com.hyphenate.mediapicker.cameralibrary.util.CameraParamUtil;
import com.hyphenate.mediapicker.cameralibrary.util.CheckPermission;
import com.hyphenate.mediapicker.cameralibrary.util.DeviceUtil;
...
//        }
        ...
        File file = new File(MediaPathUtil.getInstance().getImagePath(), videoFileName);
