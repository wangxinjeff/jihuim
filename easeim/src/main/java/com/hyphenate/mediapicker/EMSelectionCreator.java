...
public final class EMSelectionCreator {
    private final EMMatisse mEMMatisse;
     ...
     *
     * @param EMMatisse   a requester context wrapper.
     * @param EMMimeTypes MIME type set to select.
     */
    EMSelectionCreator(EMMatisse EMMatisse, @NonNull Set<EMMimeType> EMMimeTypes, boolean mediaTypeExclusive) {
        mEMMatisse = EMMatisse;
        mSelectionSpec = EMSelectionSpec.getCleanInstance();
        mSelectionSpec.EMMimeTypeSet = EMMimeTypes;
     ...
     *
     * @param EMCaptureStrategy {@link EMCaptureStrategy}, needed only when capturing is enabled.
     * @return {@link EMSelectionCreator} for fluent API.
     */
    public EMSelectionCreator captureStrategy(EMCaptureStrategy EMCaptureStrategy) {
        mSelectionSpec.EMCaptureStrategy = EMCaptureStrategy;
        return this;
    }
     ...
     *
     * @param EMImageEngine {@link EMImageEngine}
     * @return {@link EMSelectionCreator} for fluent API.
     */
    public EMSelectionCreator imageEngine(EMImageEngine EMImageEngine) {
        mSelectionSpec.EMImageEngine = EMImageEngine;
        return this;
    }
    ...
    public EMSelectionCreator setOnSelectedListener(@Nullable EMOnSelectedListener listener) {
        mSelectionSpec.EMOnSelectedListener = listener;
        return this;
    }
    ...
    public EMSelectionCreator setOnCheckedListener(@Nullable EMOnCheckedListener listener) {
        mSelectionSpec.EMOnCheckedListener = listener;
        return this;
    }
    ...
    public void forResult(int requestCode) {
        Activity activity = mEMMatisse.getActivity();
        if (activity == null) {
            return;
        }
        ...
        Fragment fragment = mEMMatisse.getFragment();
        if (fragment != null) {
