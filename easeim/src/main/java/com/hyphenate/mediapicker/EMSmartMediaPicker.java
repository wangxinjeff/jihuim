...
public class EMSmartMediaPicker {
    ...
    private EMCameraDialogFragment cameraDialogFragment;
    ...
    private EMSmartMediaPicker(Context context) {
        if (cameraDialogFragment == null) {
            cameraDialogFragment = new EMCameraDialogFragment();
    ...
    public void show() {
        //只启动照片选择
        if (config.getMediaPickerEnum() == EMMediaPickerEnum.PHOTO_PICKER) {
        ...
        //只启动相机
        else if (config.getMediaPickerEnum() == EMMediaPickerEnum.CAMERA) {
            if (fragmentActivity != null) {
    ...
    public static class Builder {
        ...
        public Builder withImageEngine(EMImageEngine imageEngine) {
        ...
        public EMSmartMediaPicker build(Context context) {
            EMSmartMediaPicker smartMediaPicker = new EMSmartMediaPicker(context);
