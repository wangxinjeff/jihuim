...
public class EMMediaPickerConfig {
     ...
     * 图片加载引擎
     */
    private EMImageEngine imageEngine;
     ...
     * CAMERA：直接跳转照相机
     */
    private EMMediaPickerEnum mediaPickerEnum;
    ...
    public EMImageEngine getImageEngine() {
        return imageEngine;
    }

    public void setImageEngine(EMImageEngine imageEngine) {
        this.imageEngine = imageEngine;
    }


    public EMMediaPickerEnum getMediaPickerEnum() {
        return mediaPickerEnum;
    }

    public void setMediaPickerEnum(EMMediaPickerEnum mediaPickerEnum) {
