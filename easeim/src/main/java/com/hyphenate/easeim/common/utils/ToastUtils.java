...
public class ToastUtils {
    ...
    public static void showCenterToast(String title, String message, int type, int duration) {
        ...
        showToast(EaseIMHelper.getInstance().getApplication(), title, message, type, duration, Gravity.CENTER);
    }
    ...
    public static void showBottomToast(String title, String message, int type, int duration) {
        ...
        showToast(EaseIMHelper.getInstance().getApplication(), title, message, type, duration, Gravity.BOTTOM);
    }
