...
public class ChatViewModel extends ConversationListViewModel {
    ...
    private SingleSourceLiveData<Resource<List<EMOrder>>> orderObservable;
    ...
    public SingleSourceLiveData<Resource<List<EMOrder>>> getOrderObservable(){
        return orderObservable;
    }

    public void getOrderList(String type){
        orderObservable.setSource(chatManagerRepository.fetchOrderListFroServer(type));
    }
}
