 ...
 * @param <T>
 */
public abstract class EaseBaseRecyclerViewAdapter<T> extends EaseBaseAdapter<EaseBaseRecyclerViewAdapter.ViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull EaseBaseRecyclerViewAdapter.ViewHolder holder, final int position) {
        ...
        holder.setDataList(mFilterData, position);
    }
    ...
    public int getItemCount() {
        return (mFilterData == null || mFilterData.isEmpty()) ? 1 : mFilterData.size();
    }

    @Override
    public int getItemViewType(int position) {
        return (mFilterData == null || mFilterData.isEmpty()) ? VIEW_TYPE_EMPTY : VIEW_TYPE_ITEM;
    }
    ...
    public synchronized T getItem(int position) {
        return mFilterData == null ? null : mFilterData.size() <= position ? null : mFilterData.get(position);
    }
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(TextUtils.isEmpty(filter)){
                    ...
                    for(T item : mData){
                        if(filterToCompare(filter, item)){
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                mFilterData = (ArrayList<T>)results.values;
                notifyDataSetChanged();
            }
        };
    }

    public boolean filterToCompare(String filter, T data){
