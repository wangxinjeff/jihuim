...
public class EaseTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        conIdView = findViewById(R.id.conversation_id);
    ...
    private void parseStyle(Context context, AttributeSet attrs){
        if(attrs != null){
            ...
            if (null != leftDrawable) {
                ...
                leftImage.setImageResource(R.drawable.em_icon_back_admin);
            }
            ...
            float titleTextSize = ta.getDimension(R.styleable.EaseTitleBar_titleBarTitleTextSize, (int) sp2px(getContext(), 16));
            ...
            if(titleTextColor != -1) {
                ...
                mTitleTextColor = ta.getColor(R.styleable.EaseTitleBar_titleBarTitleTextColor, ContextCompat.getColor(getContext(), R.color.white));
            }
